...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultEntity = 'Whitworth'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'Whitworth'; /* short name, used when referring to the software */
		$this->defaultTitle = 'Whitworth'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://whitworthbd.org';
		...
		$this->defaultSlogan = $this->l->t('because biology');
